...
sudo apt-fast install git terminator zim openjdk-11-jdk curl htop lm-sensors iproute2 inetutils-ping r-base-core gdebi-core groovy xclip sysbench python3-pip python-dev -y
